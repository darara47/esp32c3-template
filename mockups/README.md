...
| [Makiety](mockups/index.html) | 7 ekranów aplikacji — otwórz w przeglądarce |
...
jako `PROV_xxxxxx`. Sparuj przez aplikację (**Dodaj urządzenie → Nowe**) lub
przez referencyjną apkę Espressif *ESP SoftAP/BLE Prov*.

Reset konfiguracji: przytrzymaj przycisk BOOT przez 5 s po starcie albo
`idf.py erase-flash`.
